...
class MacGyver(Position):
    ...
    def move_to(self, destination):
        """ calculates the new coordinates after move to the "destination" : bottom, top, right or left of the screen
            In reception : receives a parameter "destination" as a direction "bottom", "top", "right" or "left"
